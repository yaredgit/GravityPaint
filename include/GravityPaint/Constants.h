...
constexpr float DEFAULT_GRAVITY_Y = 2.0f;  // Reduced gravity for better gameplay
...
// Gameplay
constexpr float MIN_SWIPE_DISTANCE = 30.0f;
constexpr float MAX_SWIPE_DISTANCE = 500.0f;
